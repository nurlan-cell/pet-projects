This is a first project that I write on a React Native and running by expo go. We can add new task and delete the task by tapping to the task when you complete. That's it
